...
const help = sheet([
  ...
  ["۳) شیت‌های خالی نادیده گرفته می‌شوند."],
  ["۴) برای قیمت‌ها: اگر replace_prices=true باشد، پلن‌های قبلی پاک و از نو ساخته می‌شوند."],
  ["۵) توکن پنل و BOT_TOKEN را در اکسل نگذارید — فقط در .env / سرورهای پنل داخل ربات."],
  [""],
  ["شیت‌ها:"],
  ["تنظیمات", "پیام‌ها، کارت، پشتیبانی، برند، IP Limit، حالت قیمت…"],
  ["کانال‌ها", "کانال‌های اجباری عضویت"],
  ["قیمت‌ها", "ماتریکس پلن‌ها (حجمی / ملی / نامحدود)"],
...
const settings = sheet([
  ...
  ["replace_prices", "true", "true=پاک کردن قیمت‌های قبلی قبل از ورود"],
]);
