...
- از پنل ادمین **فروش اصلی** → تنظیمات → «ظاهر ربات دمو» می‌توانید ایموجی و تم وب دمو را عوض کنید (اگر `data/demo.db` موجود باشد)  
- در خود داشبورد دمو هم بخش «ظاهر و ایموجی ربات دمو» همین کار را می‌کند  
- پیش‌فرض نمایشگاهی: Premium + Studio (یک‌بار در seed؛ بعداً از ادمین قابل تغییر) 
